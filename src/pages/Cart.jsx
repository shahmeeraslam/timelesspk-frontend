      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            ...
            <div className="flex items-center gap-6 border-l border-white/10 pl-6 h-fit">
               <div className="text-right">
                  ...
                  <p className="text-sm font-mono tracking-tighter">{cart.length} LINE_ITEMS</p>
               </div>
        ...
        {cart.length === 0 ? (
          <div className="py-48 text-center border border-white/5 bg-white/[0.01] backdrop-blur-sm relative group">
            <p className="font-mono mb-12 text-[12px] tracking-[0.6em] uppercase opacity-20">Archive_Buffer_Null</p>
                    ...
                    <div className="flex flex-col justify-between w-full py-1">
                      <div className="space-y-8">
                        <div className="flex justify-between items-start">
                          <div className="space-y-4">
                            <h3 className="text-2xl md:text-3xl font-serif italic uppercase tracking-tight leading-none group-hover:pl-2 transition-all duration-500">
                              {pData.name}
                            </h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {getSizeOptions(pData.category).map((s) => (
                                <button
                                  key={s}
                                  onClick={() => changeSize && changeSize(pId, item.color, item.size, s)}
            ...
            <div className="lg:col-span-4">
                <div className="p-10 sticky top-32 bg-white/[0.02] border border-white/10 backdrop-blur-3xl space-y-12">
                        ...
                        <div className="pt-10 border-t border-white/10 flex justify-between items-end">
                            <div className="space-y-2">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[8px] font-mono text-white/20 uppercase tracking-widest">Ready_to_Ship</span>
                              </div>
                            </div>
                    ...
                    <Link to='/place-order' className="block">
                        <button className="group relative w-full overflow-hidden bg-white py-7 text-black transition-all active:scale-[0.98]">
                          <div className="absolute inset-0 bg-neutral-200 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-700" />
